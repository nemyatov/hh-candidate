...
export class CandidateService {
    ...
    parseResume(url: string): Observable<EntityResponseType> {
        url = url.replace('https://hh.ru/resume/', '');
        return this.http.get<ICandidate>(`api/hh/candidates/${url}`, { observe: 'response' });
    }
